...
@pytest.mark.parametrize(
    "breed", ["breed/african", "breed/doberman", "breed/affenpinscher"]
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("mastiff", {"message": ["bull", "english", "tibetan"], "status": "success"}),
        ("terrier", {"message": MESSAGE, "status": "success"}),
    ],
)
